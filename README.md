...
**[Awesome-Books-ES6]** is a simple project which is made using JavaScript and it is adding, removing and storing the books into the local storage of the browser.
...
This project is created using JavaScript Modules,Classes and DOM.
...
```sh
  cd your_folder
  git clone https://github.com/SanaTameem/Awesome-books-with-ES6.git
```
...
Feel free to check the [issues page](https://github.com/SanaTameem/Awesome-books-with-ES6/issues).
